...
function submitted()
{
   ...
   let l=" ";
   if(fname_v!=""){
      document.getElementById('tr1').innerHTML=fname_v;
   }
   if(lname_v!=""){
      document.getElementById('tr2').innerHTML=lname_v;
   }
   if(addre_v!=""){
      document.getElementById('tr3').innerHTML=addre_v;
   }
   if(gender_v1.checked==true){
      document.getElementById('tr4').innerHTML="Male";
   }
   else if(gender_v2.checked==true){
      document.getElementById('tr4').innerHTML="Female";
   }
   if(state_v!=""){
      document.querySelector('.table_ans').style.cssText="display:block"
      document.getElementById('tr6').innerHTML=state_v;
   }
   if(cb1.checked==true){
      let ff=document.getElementById('tr1').value;
       l=l+ff+' '
   }
   if(cb2.checked==true){
      let ff=document.getElementById('tr2').value;
      l=l+ff+' '
   }
   if(cb3.checked==true){
      let ff=document.getElementById('tr3').value;
      l=l+ff+' '
   }
   if(cb4.checked==true){
      let ff=document.getElementById('tr4').value;
      l=l+ff+' '
   }
   if(cb5.checked==true){
      let ff=document.getElementById('tr5').value;
      l=l+ff+' '
   }
